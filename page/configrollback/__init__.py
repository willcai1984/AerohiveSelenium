...
modify_credentials_primary_invalidserver_option = (By.XPATH, '//select[@id="capwapSelect"]/option[.="1.1.1.1"]')
modify_credentials_backup_droplist = (By.XPATH, '//select[@id="capwapBackupSelect"]')
modify_credentials_backup_invalidserver_option = (By.XPATH, '//select[@id="capwapBackupSelect"]/option[.="2.2.2.2"]')
